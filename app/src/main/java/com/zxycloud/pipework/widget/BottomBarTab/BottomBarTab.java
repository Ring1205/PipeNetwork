package com.zxycloud.pipework.widget.BottomBarTab;
...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.tab_select));
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.tab_select));
