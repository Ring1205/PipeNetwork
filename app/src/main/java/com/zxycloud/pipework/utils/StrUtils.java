...
public class StrUtils {
    ...
    public static StrUtils getInstance() {
        if (timeUpUtils == null) {
            timeUpUtils = new StrUtils();
        }
        return timeUpUtils;
    }
    private static StrUtils timeUpUtils;
    private StrUtils() {
    }
    ...
    public String append(String interval, String... strings) {
        if (Utils.judgeListNull(strings) == 0) {
            return "";
        }
    ...
    public String replaceBlank(String str) {
        String dest = "";
        if (str != null) {
            Matcher m = emptyOrEnterPattern.matcher(str);
            dest = m.replaceAll("");
        }
        return dest;
    }
    ...
    public Integer getInt(TextView textText) throws NumberFormatException {
        try {
            return Integer.parseInt(textText.getText().toString().trim());
    ...
    public Float getFloat(TextView textText) throws NumberFormatException {
        try {
            return Float.parseFloat(textText.getText().toString().trim());
        } catch (NumberFormatException e) {
            return 0f;
        }
    }
    ...
    public Double getDouble(TextView textText) throws NumberFormatException {
        try {
            return Double.parseDouble(textText.getText().toString().trim());
        } catch (NumberFormatException e) {
            return 0d;
        }
    }
    ...
    public Long getLong(TextView textText) throws NumberFormatException {
        try {
            return Long.parseLong(textText.getText().toString().trim());
        } catch (NumberFormatException e) {
            return 0L;
        }
    }
